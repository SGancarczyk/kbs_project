...
# "sports"/"sport" are common interest words. We map them onto the existing
# "adventure" dimension so they are caught POSITIVELY as an interest. This also
# stops them from being silently mis-corrected into the duration keyword "short"
# (see nlp.SPELLCHECK_BLOCKLIST), turning a false positive into a true positive.
LIFESTYLE_SYNONYMS.update({
    "sports": "adventure",
    "sport": "adventure",
})
